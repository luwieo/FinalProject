...
<body>
        ...
        <main>
            ...
            <div id="home" class="cms-section-wrapper active">
                <div class="cms-section">
                    ...
                    <textarea class="form-control" rows="3"
                        placeholder="Enter welcome message here...">Welcome to the Municipality of Urbiztondo!</textarea>
                ...
                <div class="cms-section">
                    ...
                    <form action="save_news.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="title" class="form-control"
                            placeholder="e.g. New Covered Court Inaugurated" required>

                        <label class="form-label mt-3">Content</label>
                        <textarea name="content" class="form-control" rows="5"
                            placeholder="Write full news or event content..." required></textarea>

                        <label class="form-label mt-3">Image Upload</label>
                        <input type="file" name="image" class="form-control">

                        <label class="form-label mt-3">YouTube Video Link (Optional)</label>
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-success"
                                style="font-size: 1.2rem; padding: 10px 25px;">✅ Save News</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div id="health" class="cms-section-wrapper">
                <div class="cms-section">
                    ...
                    <textarea class="form-control" rows="3"
                        placeholder="Enter other emergency or health-related info..."></textarea>
                </div>
            </div>
            ...
            <!-- Save Button -->
            <div class="text-end mt-4">
                <button class="btn btn-success" style="font-size: 1.2rem; padding: 10px 25px;">✅ Save All
                    Changes</button>
            </div>
        </main>
    </section>
    ...
    document.querySelectorAll('.tab-btn').forEach(button => {
        button.addEventListener('click', () => {
            ...
            document.querySelectorAll('.cms-section-wrapper').forEach(tab => tab.classList.remove(
                'active'));
